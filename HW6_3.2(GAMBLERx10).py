...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 5 10:35:43 2018
...
class theserounds:
    ...
    ###new for the gambler because we can't really use CI's here, PI's are better!###
    def get_expectedvaluePI(self, alpha):
        return self.summary_stats1.get_PI(alpha)
    def get_expectedlossPI(self, alpha):
...
print("\n")
print("Example from Spyder for Gambler dude: EV = -40, 95% CI of EV: [-102.63629556565122, 22.636295565651224]. "
      "\n"
